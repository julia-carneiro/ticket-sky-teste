  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-cover bg-[url('assets/tela.png')]">
      <form className="p-10 bg-white rounded-xl drop-shadow-lg space-y-5" action="">
        ...
        hover:bg-blue-500 hoover:drop-shadow-md duration-300 ease-in" type="submit">Login</button>

        <button className="w-full text-blue-600 text-sm font-light hover:underline" type="submit">Fazer Cadastro</button>
      </form>
    </div>
